...
export default function Hero() {
  return (
    <section className="jungle-section relative isolate z-30 min-h-screen px-5 pt-28 text-white sm:px-8 lg:px-12">
      <Image
        src="/images/hero.png"
      ...
      <div className="absolute inset-x-0 bottom-0 -z-10 h-72 bg-gradient-to-t from-[#030805] via-[#030805]/82 to-transparent" />
      ...
      <div className="mx-auto flex min-h-[calc(100vh-7rem)] w-full max-w-6xl flex-col items-center justify-center pb-16 text-center">
        <Image
          src="/images/logo_512x512.png"
          alt="The Maze Logo"
          width={512}
          height={512}
          className="h-auto w-40 drop-shadow-[0_20px_46px_rgba(0,0,0,0.65)] animate-drop-down sm:w-48 md:w-56 lg:w-64"
          priority
        />
        ...
        <div className="relative mt-5 max-w-5xl animate-fade-in">
          ...
          <p className="font-poets text-sm uppercase tracking-[0.28em] text-[#bed36a] drop-shadow-[0_2px_10px_rgba(0,0,0,0.9)] sm:text-base">
            Endless jungle runner
          </p>
          <h1 className="mt-3 font-anton text-[clamp(3rem,12vw,8.8rem)] leading-[0.86] text-[#f4ead3] hero-title">
            <span className="block">RUN DEEPER</span>
            <span className="-mt-1 block tracking-[-0.03em] text-[#f1aa2e] sm:-mt-2 md:-mt-3">
              INTO THE MAZE
            </span>
          </h1>
          <p className="mx-auto mt-5 max-w-2xl font-poets text-lg leading-7 text-[#f7e8c4] drop-shadow-[0_3px_14px_rgba(0,0,0,0.95)] sm:text-2xl">
