...
export default function Prizes() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-32 bg-gradient-to-t from-[#030805] via-[#030805]/50 to-transparent sm:h-44 sm:via-[#030805]/62" />
